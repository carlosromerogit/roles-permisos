...
function handleSubmit() {
    form.put(`/dashboard/post/${props.post.id}`);
}
</script>
<template>
    <div>
        ...
        <div>
            <h2 class="text-2xl font-semibold mb-2">Editar post</h2>
            <hr />
        </div>
        <div>
            <form
            ...
            >
                ...
                <div class="space-x-2">
                    <button
                        type="submit"
                        class="bg-gray-800 text-gray-200 font-semibold px-4 py-2 self-start rounded"
                    >
                        Actualizar
                    </button>
                </div>
